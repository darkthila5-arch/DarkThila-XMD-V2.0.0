      ...
      <div className="max-w-7xl mx-auto p-6 lg:p-12 space-y-12 relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-[-8px] bg-primary/10 blur-3xl rounded-full" />
            {/* Rotating conic ring */}
            <motion.div
            ...
            <motion.img
              ...
              alt="Dark Thila Logo"
              className="w-32 h-32 rounded-full border-2 border-primary relative z-10 object-cover"
              style={{ boxShadow: "0 0 30px rgba(139,92,246,0.6), 0 0 70px rgba(139,92,246,0.3)" }}
