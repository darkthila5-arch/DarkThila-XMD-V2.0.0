...
// Falling purple snowflakes — denser, drift down with slight wobble
...
const LOGO_URL = "https://github.com/darkthila5-arch/image/blob/main/logo.jpg?raw=true";
...
export default function LoginPage({ onSwitchToRegister }: Props) {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* ❄️ Purple snow rain — falling top → bottom with horizontal drift */}
